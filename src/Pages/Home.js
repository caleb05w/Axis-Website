...
function Home() {
  return (
    <div className='bg-[#151515]'> 
      ...
      <div className='relative w-[100%] h-fit rounded-md mt-[10%] text-center'>
        <img className='brightness-[0.25]' src={org} alt='org' />

          <div className='absolute top-[40%] w-[100%] m-auto'>
            <div className='m-auto max-w-[33%] flex flex-col gap-[3lvh] '>
              <h2> Ready to Soar?</h2>
              <p> Join the team, come to events, and expand horizons within the field of consulting</p>
                <div className='w-100% '>
